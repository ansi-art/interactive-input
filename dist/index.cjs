...
exports.getKeyName = exports.MouseTracker = void 0;
/*
...
class MouseTracker {
  ...
  consume(event) {
    ...
    if (this.captureMouseEvents && event.data.length === 6 && event.data[0] === 27 && event.data[1] === 91 && event.data[2] === 77) {
      //mousemove
      let button = null;
      switch (event.data[3]) {
        case 67:
      ...
      const coords = {
        //offset by 32 then -1 for 0 indexed
...
// ssh connection via putty generates 127 for Backspace - weird...
{
  data: [[9]],
  keyName: Key.Tab
}, {
...
// arrows
{
  ...
  data: [[27, 91, 66]],
  keyName: Key.ArrowDown
}, {
  data: [[27, 91, 67]],
  keyName: Key.ArrowRight
}, {
  data: [[27, 91, 68]],
  keyName: Key.ArrowLeft
},
// cursor position
{
  data: [[27, 91, 49, 126]],
  ...
  data: [[27, 91, 54, 126]],
  keyName: Key.PageDown
},
// functional
{
  data: [[27, 91, 91, 65], [27, 91, 49, 49, 126]],
  keyName: Key.F1
}, {
  data: [[27, 91, 91, 66], [27, 91, 49, 50, 126]],
  keyName: Key.F2
}, {
  data: [[27, 91, 91, 67], [27, 91, 49, 51, 126]],
  keyName: Key.F3
}, {
  data: [[27, 91, 91, 68], [27, 91, 49, 52, 126]],
  keyName: Key.F4
}, {
  data: [[27, 91, 91, 69], [27, 91, 49, 53, 126]],
  keyName: Key.F5
}, {
...
const isSingleBytePrintableAscii = data => {
  ...
  return data.length === 1 && '!'.charCodeAt(0) <= data[0] && data[0] <= '}'.charCodeAt(0);
};